 ...
 *******************************************************************************/
package com.wdl.foo.utilities.email;
...
public class MimeMailService {
	...
	public void sendNotificationMail(String userName) {
		...
		try {
			...
			helper.setTo("weidaolong@outlook.com");
			helper.setFrom("weidaolong@outlook.com");
			...
			mailSender.send(msg);
			logger.info("HTML版邮件已发送至weidaolong@outlook.com");
