 ...
 *******************************************************************************/
package com.wdl.foo.modules.mail;
...
import com.wdl.foo.utilities.email.MimeMailService;
import com.wdl.foo.utilities.email.SimpleMailService;
...
public class MailServiceTest extends SpringContextTestCase {
	...
	public void sendSimpleMail() throws MessagingException, InterruptedException, IOException {
		...
		assertThat(message.getFrom()[0].toString()).isEqualTo("weidaolong@outlook.com");
